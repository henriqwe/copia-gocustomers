...
export default function CreateRepresentative() {
  ...
  async function onSubmit(formData: FormType) {
    if (
      clientData?.Pessoa.Identificador ===
      identifierUnformat(formData.Identificador)
    ) {
      return notification(
        'Não é possivel cadastrar representante com o mesmo identificador que o cliente',
        'error'
      )
    }
